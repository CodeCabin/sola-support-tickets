    ...
    <div id="sola_tabs">
      ...
      <div id="tabs-2">
          ...
          <?php if (function_exists("sola_st_pro_activate")) { ?>
                ...
                ?>
          <?php } else { ?>
          <p><?php echo __("Upgrade to the","sola_st")." <a href='http://solaplugins.com/plugins/sola-support-tickets/?utm_source=plugin&utm_medium=link&utm_campaign=st_email' title='Premium Version'>".__("Premium version","sola_st")."</a> ". __("of Sola Support Tickets and automatically convert received emails to support tickets and responses","sola_st"); ?></p>
          <?php } ?>
      </div>
      <div id="tabs-3">
          ...
          <?php } else { ?>
          <p><?php echo __("Upgrade to the","sola_st")." <a href='http://solaplugins.com/plugins/sola-support-tickets/?utm_source=plugin&utm_medium=link&utm_campaign=st_agents' title='Premium Version'>".__("Premium version","sola_st")."</a> ". __("of Sola Support Tickets and assign more than one support agent.","sola_st"); ?></p>
          <?php } ?>
      </div>

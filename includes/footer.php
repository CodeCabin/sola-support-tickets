...
<div class="footer" style="padding:15px 7px;">
    <div id=foot-contents>
        <div class="support">
            ...
            <br />Sola Newsletter Premium Version: <a target='_BLANK' href="http://solaplugins.com/plugins/sola-support-tickets-helpdesk-plugin/?utm_source=plugin&utm_medium=link&utm_campaign=st_sversion_premium"><?php echo $sola_st_pro_version.$sola_st_pro_version_string; ?></a> |
            ...
            <a target="_blank" id="uppgrade" href="http://solaplugins.com/plugins/sola-support-tickets-helpdesk-plugin/?utm_source=plugin&utm_medium=link&utm_campaign=st_footer" title="Premium Upgrade">Go Premium</a>
            <?php } ?>

jQuery("document").ready(function() {
   ...
   jQuery(".sola_st_send_response_btn").click(function (){
    ...
    jQuery(".sola_st_save_note_btn").click(function (){
        ...
        var post_response = escape(jQuery("#sola_st_note_text").val());
        var post_title = escape(jQuery("#sola_st_note_title").val());
        var post_author = escape(jQuery("#sola_st_note_author").val());
